...
{
    public static IOrderedQueryable<T> Sort<Y, T>(this IQueryable<T> entity, string? sortType,
        Func<string, Expression<Func<T, object>>> switcher) where Y : StronglyTypeId where T : BaseEntityWithoutId
    {
